...
void singleElectron_test(const char *inputFile)
{
  // Setting for figures
  ...
  for(entry = 0; entry < allEntries; ++entry)
  {
	...
	int iEta, iPt, iP;
        ...
        cout << "** inside more more Track branch" << endl;
	...
	if (particle->PID == 11)
	{
          cout << "** inside more more more Track branch" << endl;
    ...
    cout << "** outside Track branch" << endl; 
    if (branchElectron->GetEntries() > 0)
    {
      cout << "** inside Electron branch" << endl;
    ...
    {
      cout << "** inside EFlowTrack branch" << endl;
	...
	for (int j=0; j< tower->Particles.GetEntriesFast(); ++j)
	{
        ...
        } // for statements for gen tower particles
      ...
      } // for statement tower branch 
    } // if statement to check tower branch exists
    //if (entry < 1) break;
  } // for statement all events
